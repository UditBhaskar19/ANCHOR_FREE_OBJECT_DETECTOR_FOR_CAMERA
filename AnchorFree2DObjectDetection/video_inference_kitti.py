...
if __name__ == '__main__':
    ...
    # annotations_list, _, _ \
    #     = load_specific_sequence_groundtruths_json(scene, aggregated_label_path, label_rootdir, dataset_rootdir)
    # for annotation in annotations_list:
    #     vframe = cv2.imread(annotation['image_path'])
