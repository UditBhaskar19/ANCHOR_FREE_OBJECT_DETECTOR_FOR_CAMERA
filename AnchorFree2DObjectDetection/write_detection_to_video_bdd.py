...
NMS_THRESH = 0.35
SCORE_THRESH = [0.7, 0.4]

# IN_VIDEO_DIR = 'D:/Downloads/bdd100k_videos_test_00/bdd100k/videos/test/'
# IN_VIDEO_DIR = 'D:/Downloads/bdd100k_videos_train_00/bdd100k/videos/train/'
IN_VIDEO_DIR = 'dataset/bdd/video_clips'
IN_VIDEO_DIR = os.path.join(dataset_rootdir, IN_VIDEO_DIR)
OUT_VIDEO_DIR = 'video_inference/bdd/train1'
...
if __name__ == '__main__':
    ...
    for i in range(start_idx, start_idx + num_samples):
        ...
        in_video_path = video_paths[i]
        out_video_path = os.path.join(OUT_VIDEO_DIR, 'det_' + video_names[i])

        print(f"video {i}: {video_names[i]}")
