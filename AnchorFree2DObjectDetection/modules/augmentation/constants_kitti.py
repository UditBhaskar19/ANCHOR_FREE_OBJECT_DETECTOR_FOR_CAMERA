# ---------------------------------------------------------------------------------------------------------------
# Author : Udit Bhaskar
# Description : KITTI dataset augmentation parameters/constants
# ---------------------------------------------------------------------------------------------------------------
import cv2
...
_PROB_GEOMETRIC_  = 0.2

_PROB_MOSAIC_ = 0.8   # 0.8
_PROB_MIXUP_ = 0.1    # 0.1
_PROB_FLIP_ = 0.5     # 0.5
_PROB_CROP_ = 0.7     # 0.7

_H_GAIN_ = 0.015      # 0.015
_S_GAIN_ = 0.7        # 0.7
_V_GAIN_ = 0.4        # 0.4

_MAX_DEGREE_ = 5        # 10
_MAX_TRANSLATE_ = 0.1   # 0.1
_MAX_SCALE_ = 0.25      # 0.25
_MAX_SHEAR_ = 0         # 0
_PERSPECTIVE_ = 0       # 0
