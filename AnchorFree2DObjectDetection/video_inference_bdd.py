...
video_dir1 = 'D:/Downloads/bdd100k_videos_test_00/bdd100k/videos/test/'
clip1 = 'caeb0fbb-410c10ca.mov'
clip2 = 'cae23877-a1826db4.mov'
clip3 = 'cadf77c3-2857db38.mov'
clip4 = 'cad03998-e6cc2ae6.mov'
clip5 = 'cad180c4-2edc9315.mov'
clip6 = 'cad180c4-d05b49f1.mov'
clip7 =  'cabc30fc-eb673c5a.mov' # '01621265-578a97d7.mov'

clip1b =  '01621265-578a97d7.mov'
video_dir2 = 'D:/Downloads/bdd100k_videos_train_00/bdd100k/videos/train'

video_file = clip4
video_path = os.path.join(video_dir1, video_file)

# video_file = clip1b
# video_path = os.path.join(video_dir2, video_file)

NMS_THRESH = 0.35
SCORE_THRESH = [0.8, 0.55]
